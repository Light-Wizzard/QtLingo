...
#    fi
    ...
    sudo apt install -qqy libffi-dev mesa-common-dev libglu1-mesa-dev freeglut3-dev libegl1-Mesa-dev libmesa-dev pkg-config;
    ...
    sudo apt install -qqy libhdf5-dev doxygen libssl1.0.0 libopenexr-dev libpcl-dev;
    # Python
