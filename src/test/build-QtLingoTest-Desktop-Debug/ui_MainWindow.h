...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/images/google_translate.png"), QSize(), QIcon::Normal, QIcon::On);
        checkBoxSettingsGoogle->setIcon(icon9);
        ...
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/images/yandex_translate.png"), QSize(), QIcon::Normal, QIcon::On);
        checkBoxSettingsYandex->setIcon(icon10);
        ...
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/images/microsoft_translator.png"), QSize(), QIcon::Normal, QIcon::On);
        checkBoxSettingsBing->setIcon(icon11);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 1157, 1202));
